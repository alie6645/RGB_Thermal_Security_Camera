...
def resize_rgb_to_therm(img):
    return cv2.resize(img, (320, 320), interpolation=cv2.INTER_AREA)

if __name__ == "__main__":
    batch_crop_resize(rgb_dir_in, rgb_dir_out, (0, 0, 270, 320), (200, 200), func=resize_rgb_to_therm)
    batch_crop_resize(therm_dir_in, therm_dir_out, (0, 0, 200, 200), (200, 200))
